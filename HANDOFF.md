...
| CI green on a self-hosted runner | ✅ | success — run 34975889872, 2026-09-15 |
...
| | State | Id |
|---|---|---|
| Bundle id registered | ✅ | `com.altixcode.quizburst` |
| App Store Connect record | ✅ | `6812380943` — store name "Quizburst" |
| App Store category | ✅ | GAMES / EDUCATION |
...
| AdMob app — iOS | ✅ | `ca-app-pub-2504845459806550~6386233882` |
| AdMob app — Android | ✅ | `ca-app-pub-2504845459806550~9042607802` |
| AdMob ad units (6) | ✅ | iOS banner/interstitial/rewarded `3391660028` / `1821584172` / `2063845491`; Android `9508502508` / `5650157703` / `2078578354` |
...
| RevenueCat project, apps, entitlement, offering | ✅ | project `proj15cc7719`, entitlement `entlee7fb5d109`, offering `ofrng00c8a5d6c9` |
