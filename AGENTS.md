...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs quizburst`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.quizburst` |
| Scheme | `quizburst://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.quizburst.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/quizburst` |
