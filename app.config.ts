...
/**
 * Store identity and native configuration for Quizburst.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Quizburst works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.quizburst',
    buildNumber: BUILD,
    supportsTablet: true,
  ...
  android: {
    package: 'com.altixcode.quizburst',
